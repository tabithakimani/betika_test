<template>
  <!--  Mobile Cart-->
  <div :class="cart ? 'cart-open' : 'cart-close'"
       class="cart p-3 w-[80%] absolute right-0 bg-white overflow-x-scroll top-0 h-screen z-50 md:invisible space-y-10">
    ...
    <ul class="h-96 overflow-y-auto">
      <li class="flex flex-wrap group mb-8">
        <div class="mr-5 relative">
          <a href="#"><img src="../assets/images/wine_bottle.png" alt="product image" class="object-scale-down"
        ...
        <div class="flex-1 pr-3">
          ...
          <span class="font-light text-sm text-dark transition-all tracking-normal">1 x <span>$80.00</span></span>
...
<!--  Default Cart-->
  <div class="rounded overflow-hidden md:w-2/5 w-0 invisible md:visible">
    <div class="shadow border p-8">
      ...
      <div class="text-center">
        <a class="py-5 px-10 block bg-white border border-solid border-gray-400 uppercase font-semibold text-base hover:bg-red-950 hover:border-red-950 hover:text-white transition-all leading-none"
           href="">Checkout</a>
      </div>
    </div>
  </div>
...
export default {
  ...
  // mounted() {
  //   this.$root.$on('open_cart_event', function(){
  //     this.open_cart()
  //   })
  // },
